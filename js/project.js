...
let title = div.append("h2")
  ...
  .text("Prosper Total Loan Between 2005 - 2014");
...
function loan(data) {
  ...
  let message = `<h2>Overview</h2>
                  <h3 class="report">1) Before 2013, total loan amount increased as the year increased</h3>
                  <h3 class="report">2) Total loan amount declined extremely after 2013</h3>
                  <h3 class="report"style="color:red">3) Click data point for more information</h3>`;
